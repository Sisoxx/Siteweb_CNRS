...
'''
T,ST,V1,RLOI,input_choice, low_range_input, high_range_input,round_step_input = input_T, input_ST, input_V1, input_RLOI, input_choice, low_range_input, high_range_input,round_step_input
