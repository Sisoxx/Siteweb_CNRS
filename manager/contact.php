...
//Enregistre les données dans la BDD et rédireige en fonction du résultat //
  ...
  $mail->Username   = 'nadine.joachimowicz@geeps.centralesupelec.fr';                     // SMTP username
  ...
  $mail->setFrom('nadine.joachimowicz@geeps.centralesupelec.fr', 'Nouvelle demande de contact');
