...
try:
    volumebecher = float(sys.argv[9])
except:
    print("il manque un argument 9")

print (calculmasse(input_T, input_ST, input_V1, input_RLOI, input_choice, low_range_input, high_range_input,round_step_input, volumebecher))
